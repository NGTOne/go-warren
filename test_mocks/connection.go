...
func (m *MockConnection) AckMessage(arg0 conn.Message) error {
...
func (m *MockConnection) NackMessage(arg0 conn.Message) error {
...
func (m *MockConnection) SetNewMessageCallback(arg0 func(conn.Message)) {
